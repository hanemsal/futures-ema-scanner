...
MIN_VOL_RATIO = env_float("MIN_VOL_RATIO", 2.2)
STRONG_VOL_RATIO = env_float("STRONG_VOL_RATIO", 3.0)
...
ARM_TRAILING_AT_PROFIT_PCT = env_float("ARM_TRAILING_AT_PROFIT_PCT", 6.0)
TRAILING_GIVEBACK_PCT = env_float("TRAILING_GIVEBACK_PCT", 3.0)

HARD_STOP_PCT = env_float("HARD_STOP_PCT", -3.0)
